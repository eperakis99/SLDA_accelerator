...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vec_vec_op_streaming.autotvin.dat"
	set constFileTvOut       "vec_vec_op_streaming.autotvout.dat"
	set constFileHdlTvIn     "vec_vec_op_streaming.autohdltvin.dat"
	set constFileHdlTvOut    "vec_vec_op_streaming.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
