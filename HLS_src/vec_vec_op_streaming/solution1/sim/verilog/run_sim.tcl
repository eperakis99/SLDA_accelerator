...
if {[file isfile vec_vec_op_streaming.autotvin.dat]} {
	file delete -force vec_vec_op_streaming.autotvin.dat
}

if {[file isfile vec_vec_op_streaming.autotvout.dat]} {
	file delete -force vec_vec_op_streaming.autotvout.dat
}
