set moduleName vector_subtract
set isTopModule 0
...
set C_modelName {vector_subtract}
...
set C_modelArgMapList {[ 
	{ "Name" : "vec1_V_data_V", "interface" : "axis", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "vec1_V_keep_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "vec1_V_strb_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "vec1_V_user_V", "interface" : "axis", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "vec1_V_last_V", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "vec1_V_id_V", "interface" : "axis", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "vec1_V_dest_V", "interface" : "axis", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "vec2_V_data_V", "interface" : "axis", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "vec2_V_keep_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "vec2_V_strb_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "vec2_V_user_V", "interface" : "axis", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "vec2_V_last_V", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "vec2_V_id_V", "interface" : "axis", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "vec2_V_dest_V", "interface" : "axis", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ vec2_TDATA sc_in sc_lv 128 signal 7 } 
	{ vec2_TVALID sc_in sc_logic 1 invld 7 } 
	{ vec2_TREADY sc_out sc_logic 1 inacc 13 } 
	{ vec2_TKEEP sc_in sc_lv 16 signal 8 } 
	{ vec2_TSTRB sc_in sc_lv 16 signal 9 } 
	{ vec2_TUSER sc_in sc_lv 2 signal 10 } 
	{ vec2_TLAST sc_in sc_lv 1 signal 11 } 
	{ vec2_TID sc_in sc_lv 5 signal 12 } 
	{ vec2_TDEST sc_in sc_lv 6 signal 13 } 
	{ vec_out_TDATA sc_out sc_lv 128 signal 14 } 
	{ vec_out_TVALID sc_out sc_logic 1 outvld 20 } 
	{ vec_out_TREADY sc_in sc_logic 1 outacc 14 } 
	{ vec_out_TKEEP sc_out sc_lv 16 signal 15 } 
	{ vec_out_TSTRB sc_out sc_lv 16 signal 16 } 
	{ vec_out_TUSER sc_out sc_lv 2 signal 17 } 
	{ vec_out_TLAST sc_out sc_lv 1 signal 18 } 
	{ vec_out_TID sc_out sc_lv 5 signal 19 } 
	{ vec_out_TDEST sc_out sc_lv 6 signal 20 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vec1_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "vec1_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "vec2_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "vec2_V_data_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	vec1_V_data_V { axis {  { vec1_TDATA in_data 0 128 }  { vec1_TVALID in_vld 0 1 } } }
	...
	vec1_V_dest_V { axis {  { vec1_TREADY in_acc 1 1 }  { vec1_TDEST in_data 0 6 } } }
	vec2_V_data_V { axis {  { vec2_TDATA in_data 0 128 }  { vec2_TVALID in_vld 0 1 } } }
	...
	vec2_V_dest_V { axis {  { vec2_TREADY in_acc 1 1 }  { vec2_TDEST in_data 0 6 } } }
