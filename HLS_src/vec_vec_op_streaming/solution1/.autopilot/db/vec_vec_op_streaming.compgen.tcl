...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 78 \
			corename vec_vec_op_streaming_BUS_A_axilite \
			name vec_vec_op_streaming_BUS_A_s_axi \
			ports {$port_BUS_A} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler vec_vec_op_streaming_BUS_A_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { vec1_TVALID { I 1 bit } vec1_TREADY { O 1 bit } vec1_TDEST { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { vec2_TVALID { I 1 bit } vec2_TREADY { O 1 bit } vec2_TDEST { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { vec_out_TDATA { O 128 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { vec_out_TVALID { O 1 bit } vec_out_TREADY { I 1 bit } vec_out_TDEST { O 6 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 100
set RegSliceName vec_vec_op_streaming_regslice_both
set RegSliceInstName vec_vec_op_streaming_regslice_both_U
set CoreName ap_simcore_vec_vec_op_streaming_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
