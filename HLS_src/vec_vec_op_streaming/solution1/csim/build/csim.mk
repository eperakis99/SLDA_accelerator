...
HLS_SOURCES = ../../../../vec_vec_op_streaming_tb.cpp ../../../../vec_vec_op_streaming.cpp
...
$(ObjDir)/vec_vec_op_streaming_tb.o: ../../../../vec_vec_op_streaming_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../vec_vec_op_streaming_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/vec_vec_op_streaming_tb.d
