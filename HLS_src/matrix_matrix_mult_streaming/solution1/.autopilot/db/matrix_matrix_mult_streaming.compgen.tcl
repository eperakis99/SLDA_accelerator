...
set ID 834
set hasByteEnable 0
set MemName matrix_matrix_mult_streaming_W_V_0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 835 \
			corename matrix_matrix_mult_streaming_CTRL_BUS_axilite \
			name matrix_matrix_mult_streaming_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matrix_matrix_mult_streaming_CTRL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { feature_vector_TDATA { I 128 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { feature_vector_TVALID { I 1 bit } feature_vector_TREADY { O 1 bit } feature_vector_TDEST { I 6 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 844
set RegSliceName matrix_matrix_mult_streaming_regslice_both
set RegSliceInstName matrix_matrix_mult_streaming_regslice_both_U
set CoreName ap_simcore_matrix_matrix_mult_streaming_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix matrix_matrix_mult_streaming_ \
    sliceTypeList 0\
}"
} else {
