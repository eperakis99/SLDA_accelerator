...
if {[file isfile matrix_matrix_mult_streaming.autotvin.dat]} {
	file delete -force matrix_matrix_mult_streaming.autotvin.dat
}

if {[file isfile matrix_matrix_mult_streaming.autotvout.dat]} {
	file delete -force matrix_matrix_mult_streaming.autotvout.dat
}
