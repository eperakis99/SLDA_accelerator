...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrix_matrix_mult_streaming.autotvin.dat"
	set constFileTvOut       "matrix_matrix_mult_streaming.autotvout.dat"
	set constFileHdlTvIn     "matrix_matrix_mult_streaming.autohdltvin.dat"
	set constFileHdlTvOut    "matrix_matrix_mult_streaming.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
