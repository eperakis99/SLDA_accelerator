...
if {[file isfile SLDA_final.autotvin.dat]} {
	file delete -force SLDA_final.autotvin.dat
}

if {[file isfile SLDA_final.autotvout.dat]} {
	file delete -force SLDA_final.autotvout.dat
}
