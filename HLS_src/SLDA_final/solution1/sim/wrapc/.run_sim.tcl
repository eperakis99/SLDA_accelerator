...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "SLDA_final.autotvin.dat"
	set constFileTvOut       "SLDA_final.autotvout.dat"
	set constFileHdlTvIn     "SLDA_final.autohdltvin.dat"
	set constFileHdlTvOut    "SLDA_final.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
