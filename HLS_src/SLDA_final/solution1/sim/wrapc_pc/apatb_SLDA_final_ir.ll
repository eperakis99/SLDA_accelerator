; ModuleID = '/home/manolis/HLS_code/SLDA_final/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream.6" = type { %"struct.hls::axis.5" }
%"struct.hls::axis.5" = type { %struct.ap_int, %struct.ap_uint, %struct.ap_uint, %struct.ap_uint.0, %struct.ap_uint.3, %struct.ap_uint.6, %struct.ap_uint.9 }
%struct.ap_int = type { %struct.ap_int_base.2 }
...
%struct.ap_int.0 = type { %struct.ap_int_base.1.14 }
%struct.ap_int_base.1.14 = type { %struct.ssdm_int.2.13 }
%struct.ssdm_int.2.13 = type { i32 }

; Function Attrs: argmemonly nounwind
declare void @llvm.memcpy.p0i8.p0i8.i64(i8* nocapture writeonly, i8* nocapture readonly, i64, i1) #0

; Function Attrs: noinline
define void @apatb_SLDA_final_ir(%"class.hls::stream.6"* %mu_in, %"class.hls::stream.6"* %feature_vector1, %"class.hls::stream.6"* %feature_vector2, %"class.hls::stream.6"* %Lambda, %struct.ap_int.0* %scores, i32 %reset, i32 %init, i32* %ready, i32* %complete) local_unnamed_addr #1 {
entry:
  %mu_in_copy = alloca %"class.hls::stream.6", align 512
  %feature_vector1_copy = alloca %"class.hls::stream.6", align 512
  %feature_vector2_copy = alloca %"class.hls::stream.6", align 512
  %Lambda_copy = alloca %"class.hls::stream.6", align 512
  %scores_copy = alloca [10 x %struct.ap_int.0], align 512
  %ready_copy = alloca i32, align 512
  %complete_copy = alloca i32, align 512
  %0 = bitcast %struct.ap_int.0* %scores to [10 x %struct.ap_int.0]*
  call fastcc void @copy_in(%"class.hls::stream.6"* %mu_in, %"class.hls::stream.6"* nonnull align 512 %mu_in_copy, %"class.hls::stream.6"* %feature_vector1, %"class.hls::stream.6"* nonnull align 512 %feature_vector1_copy, %"class.hls::stream.6"* %feature_vector2, %"class.hls::stream.6"* nonnull align 512 %feature_vector2_copy, %"class.hls::stream.6"* %Lambda, %"class.hls::stream.6"* nonnull align 512 %Lambda_copy, [10 x %struct.ap_int.0]* %0, [10 x %struct.ap_int.0]* nonnull align 512 %scores_copy, i32* %ready, i32* nonnull align 512 %ready_copy, i32* %complete, i32* nonnull align 512 %complete_copy)
  %1 = getelementptr inbounds [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %scores_copy, i32 0, i32 0
  call void @apatb_SLDA_final_hw(%"class.hls::stream.6"* %mu_in_copy, %"class.hls::stream.6"* %feature_vector1_copy, %"class.hls::stream.6"* %feature_vector2_copy, %"class.hls::stream.6"* %Lambda_copy, %struct.ap_int.0* %1, i32 %reset, i32 %init, i32* %ready_copy, i32* %complete_copy)
  call fastcc void @copy_out(%"class.hls::stream.6"* %mu_in, %"class.hls::stream.6"* nonnull align 512 %mu_in_copy, %"class.hls::stream.6"* %feature_vector1, %"class.hls::stream.6"* nonnull align 512 %feature_vector1_copy, %"class.hls::stream.6"* %feature_vector2, %"class.hls::stream.6"* nonnull align 512 %feature_vector2_copy, %"class.hls::stream.6"* %Lambda, %"class.hls::stream.6"* nonnull align 512 %Lambda_copy, [10 x %struct.ap_int.0]* %0, [10 x %struct.ap_int.0]* nonnull align 512 %scores_copy, i32* %ready, i32* nonnull align 512 %ready_copy, i32* %complete, i32* nonnull align 512 %complete_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, [10 x %struct.ap_int.0]*, [10 x %struct.ap_int.0]* noalias align 512, i32* readonly, i32* noalias align 512, i32* readonly, i32* noalias align 512) unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* align 512 %1, %"class.hls::stream.6"* %0)
  ...
  call fastcc void @onebyonecpy_hls.p0a10struct.ap_int.0([10 x %struct.ap_int.0]* align 512 %9, [10 x %struct.ap_int.0]* %8)
...
; Function Attrs: noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"* noalias) unnamed_addr #3 {
entry:
...
; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base(%struct.ap_int_base* align 16 %.01.1.013, %struct.ap_int_base* %.0.1.012)
  br label %34
...
; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int(%struct.ssdm_int* align 16 %.01.1.0.015, %struct.ssdm_int* %.0.1.0.014)
  br label %34
...
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* noalias nocapture align 512, %"class.hls::stream.6"* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int(%struct.ap_int* noalias nocapture align 512, %struct.ap_int* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.2(%struct.ap_int_base.2* noalias nocapture align 512, %struct.ap_int_base.2* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.1(%struct.ssdm_int.1* noalias nocapture align 512, %struct.ssdm_int.1* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.6(%struct.ap_uint.6* noalias nocapture, %struct.ap_uint.6* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.7(%struct.ap_int_base.7* noalias nocapture, %struct.ap_int_base.7* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.8(%struct.ssdm_int.8* noalias nocapture, %struct.ssdm_int.8* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.9(%struct.ap_uint.9* noalias nocapture, %struct.ap_uint.9* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.10(%struct.ap_int_base.10* noalias nocapture, %struct.ap_int_base.10* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.11(%struct.ssdm_int.11* noalias nocapture, %struct.ssdm_int.11* noalias nocapture) unnamed_addr #4 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a10struct.ap_int.0([10 x %struct.ap_int.0]* noalias align 512, [10 x %struct.ap_int.0]* noalias) unnamed_addr #3 {
entry:
  %2 = icmp eq [10 x %struct.ap_int.0]* %0, null
  %3 = icmp eq [10 x %struct.ap_int.0]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop.head, %copy
  ...
  %dst.addr = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %1, i64 0, i64 %for.loop.idx9
...
; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %0, i64 0, i64 %for.loop.idx9, i32 0
  %9 = bitcast %struct.ap_int_base.1.14* %src.addr.01 to i8*
  %10 = call i1 @fpga_fifo_exist_4(i8* %9)
  br i1 %10, label %11, label %12

; <label>:11:                                     ; preds = %8
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.1.14(%struct.ap_int_base.1.14* %dst.addr.02, %struct.ap_int_base.1.14* %src.addr.01)
  br label %for.loop.head

; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %13 = bitcast %struct.ssdm_int.2.13* %src.addr.0.03 to i8*
  %14 = call i1 @fpga_fifo_exist_4(i8* %13)
  br i1 %14, label %15, label %16

; <label>:15:                                     ; preds = %12
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.2.13(%struct.ssdm_int.2.13* %dst.addr.0.04, %struct.ssdm_int.2.13* %src.addr.0.03)
  br label %for.loop.head

; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i32* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [10 x %struct.ap_int.0], [10 x %struct.ap_int.0]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.1.14(%struct.ap_int_base.1.14* noalias nocapture, %struct.ap_int_base.1.14* noalias nocapture) unnamed_addr #4 {
entry:
  %2 = alloca %struct.ap_int_base.1.14
  br label %empty

empty:                                            ; preds = %push, %entry
  %3 = bitcast %struct.ap_int_base.1.14* %1 to i8*
  %4 = call i1 @fpga_fifo_not_empty_4(i8* %3)
  br i1 %4, label %push, label %ret

push:                                             ; preds = %empty
  %5 = bitcast %struct.ap_int_base.1.14* %2 to i8*
  %6 = bitcast %struct.ap_int_base.1.14* %1 to i8*
  call void @fpga_fifo_pop_4(i8* %5, i8* %6)
  %7 = load volatile %struct.ap_int_base.1.14, %struct.ap_int_base.1.14* %2
  %8 = bitcast %struct.ap_int_base.1.14* %2 to i8*
  %9 = bitcast %struct.ap_int_base.1.14* %0 to i8*
  call void @fpga_fifo_push_4(i8* %8, i8* %9)
  br label %empty, !llvm.loop !26

ret:                                              ; preds = %empty
  %10 = bitcast %struct.ap_int_base.1.14* %1 to i8*
  %11 = bitcast %struct.ap_int_base.1.14* %0 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %11, i8* align 1 %10, i64 4, i1 false)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.2.13(%struct.ssdm_int.2.13* noalias nocapture, %struct.ssdm_int.2.13* noalias nocapture) unnamed_addr #4 {
entry:
  %2 = alloca %struct.ssdm_int.2.13
  br label %empty

empty:                                            ; preds = %push, %entry
  %3 = bitcast %struct.ssdm_int.2.13* %1 to i8*
  %4 = call i1 @fpga_fifo_not_empty_4(i8* %3)
  br i1 %4, label %push, label %ret

push:                                             ; preds = %empty
  %5 = bitcast %struct.ssdm_int.2.13* %2 to i8*
  %6 = bitcast %struct.ssdm_int.2.13* %1 to i8*
  call void @fpga_fifo_pop_4(i8* %5, i8* %6)
  %7 = load volatile %struct.ssdm_int.2.13, %struct.ssdm_int.2.13* %2
  %8 = bitcast %struct.ssdm_int.2.13* %2 to i8*
  %9 = bitcast %struct.ssdm_int.2.13* %0 to i8*
  call void @fpga_fifo_push_4(i8* %8, i8* %9)
  br label %empty, !llvm.loop !27

ret:                                              ; preds = %empty
  %10 = bitcast %struct.ssdm_int.2.13* %1 to i8*
  %11 = bitcast %struct.ssdm_int.2.13* %0 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %11, i8* align 1 %10, i64 4, i1 false)
  ret void
}
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, [10 x %struct.ap_int.0]*, [10 x %struct.ap_int.0]* noalias align 512, i32*, i32* noalias readonly align 512, i32*, i32* noalias readonly align 512) unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* %0, %"class.hls::stream.6"* align 512 %1)
  ...
  call fastcc void @onebyonecpy_hls.p0a10struct.ap_int.0([10 x %struct.ap_int.0]* %8, [10 x %struct.ap_int.0]* align 512 %9)
...
declare void @apatb_SLDA_final_hw(%"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %struct.ap_int.0*, i32, i32, i32*, i32*)

define void @SLDA_final_hw_stub_wrapper(%"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %struct.ap_int.0*, i32, i32, i32*, i32*) #7 {
entry:
  %9 = bitcast %struct.ap_int.0* %4 to [10 x %struct.ap_int.0]*
  call void @copy_out(%"class.hls::stream.6"* null, %"class.hls::stream.6"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, [10 x %struct.ap_int.0]* null, [10 x %struct.ap_int.0]* %9, i32* null, i32* %7, i32* null, i32* %8)
  %10 = bitcast [10 x %struct.ap_int.0]* %9 to %struct.ap_int.0*
  call void @SLDA_final_hw_stub(%"class.hls::stream.6"* %0, %"class.hls::stream.6"* %1, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* %3, %struct.ap_int.0* %10, i32 %5, i32 %6, i32* %7, i32* %8)
  call void @copy_in(%"class.hls::stream.6"* null, %"class.hls::stream.6"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, [10 x %struct.ap_int.0]* null, [10 x %struct.ap_int.0]* %9, i32* null, i32* %7, i32* null, i32* %8)
  ret void
}

declare void @SLDA_final_hw_stub(%"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %struct.ap_int.0*, i32, i32, i32*, i32*)
